...
const LaunchToken = ({ talent, railsContext, setLocalTalent, canUpdate }) => {
  ...
  return (
    <>
      ...
      <section className={cx("d-flex flex-column mx-4 launch-token-section", mobile ? "p-3" : "p-5 pt-6")}>
        <div className="row">
          <div className={cx("col-12 col-lg-6", mobile ? "mb-6" : "mt-7")}>
            <H3 className="inverted-text-primary-01 mb-0">
              Launch a <span className="highlight-word">Talent Token</span> and unlock benefits for{" "}
          ...
          <div className={cx("col-12 col-lg-6", !mobile && "d-flex flex-column justify-content-end")}>
            <div className="d-flex mt-6">
              ...
              >
                <P2 bold text={requiredFields.length > 0 ? "Profile Incomplete" : "Launch my token"} />
