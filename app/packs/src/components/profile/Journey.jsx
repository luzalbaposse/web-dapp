            ...
            <div className="d-flex">
              {!mobile && (
                <P3
                  ...
                  bold
                  text={dayjs(goal.dueDate, "YYYY-MM-DD").format("MMM-YYYY")}
                />
              )}
              ...
              <div className={cx(mobile ? "col-10 pt-2" : "col-9 pt-1")}>
                ...
                <P1 className="text-primary-01 mb-3" bold text={goal.title} />
          ...
          {sortedMilestones.map((milestone) => (
            <div className="d-flex">
              ...
              <div className={cx(mobile ? "col-10 pt-2" : "col-9 pt-1")}>
                ...
                />
                <P2 className="text-primary-03" text={milestone.description} />
                <Divider className="my-5" />
              </div>
            </div>
          ))}
