...
import { displayableAmount, formattedConnectionType } from "src/utils/viewHelpers";
...
const CommunityTable = ({ connections, rowAction, mode, ticker, mobile }) => {
  return (
    <Table mode={mode}>
      <Table.Head>
        <Table.Th>
      ...
      <Table.Body>
        {connections.map(connection => (
          <Table.Tr key={connection.id} onClick={() => rowAction(connection)}>
            <Table.Td>
...
const Community = ({ userId, talent, canUpdate, rowAction }) => {
