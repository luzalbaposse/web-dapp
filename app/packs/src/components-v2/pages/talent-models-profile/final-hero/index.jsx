...
export const FinalHero = () => (
    <Container>
        <Avatar size="lg" />
        <Headline>
            <Typography specs={{ variant: "h4", type: "regular"}} color="primary01">--E </Typography>
            <Typography specs={{ variant: "h4", type: "regular"}} color="primary01">{PHRASE[0]}</Typography>
            <Typography specs={{ variant: "h4", type: "regular"}} color="primary">{PHRASE[1]}</Typography>
        </Headline>
        <SocialList>
