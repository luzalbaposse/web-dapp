import { Button, Dropdown, Input, Modal, Typography } from "@talentprotocol/design-system";
import React, { useState } from "react";
import { Container, BottomContainer, ClaimArea, ClaimAreaHeader, ClaimAreaInput, ClaimAreaInputContainer } from "./styled";
    ...
    <Modal title="Sponsorship" isOpen={modalState.isOpen} closeModal={modalState.closeModal}>
      ...
      <ClaimArea>
        ...
        <ClaimAreaInput>
          ...
          <Dropdown value={token} options={["CUSD", "USDC"]} placeholder="USDC" selectValue={(token) => {
            setToken(token);
          }}/>
        </ClaimAreaInput>
      </ClaimArea>
