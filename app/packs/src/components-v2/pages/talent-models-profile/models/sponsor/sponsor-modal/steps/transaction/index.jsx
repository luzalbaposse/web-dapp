...
export const TransactionStep = ({
  ...
  const onSubmit = async (e) => {
    ...
    const result = await onchain
      .createSponsorship(account, amount)
      .catch((error) => {
        console.error(error);
      });
    ...
    <>
      <Container>
        ...
        <Typography
          ...
          color="primary03"
        >
          Please note that this is an estimate and the actual value may vary
          based on the Ethereum gas fee.
        </Typography>
        <BottomContainer>
          <Button
            size="large"
