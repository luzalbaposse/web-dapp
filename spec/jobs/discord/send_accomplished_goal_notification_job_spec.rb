...
RSpec.describe Discord::SendAccomplishedGoalNotificationJob, type: :job do
  include ActiveJob::TestHelper

  let(:goal_id) { goal.id }
  let(:goal) { create :goal }

  let(:notification_class) { Discord::AccomplishedGoalNotification }
  ...
  describe "#perform" do
    it "initializes and calls the Discord accomplished goal notification with the goal" do
