...
RSpec.describe "Subscribes API" do
  path "/subscribers" do
    get "Retrieves the subscribers of a talent" do
      ...
      before do
        create :subscribe, user: talent_user, subscriber: user_1
        create :subscribe, user: talent_user, subscriber: user_2
      end
  ...
  path "/subscribing" do
    get "Retrieves the talents a talent is subscribing" do
      ...
      before do
        create :subscribe, user: user_1, subscriber: talent_user
        create :subscribe, user: user_2, subscriber: talent_user
      end
