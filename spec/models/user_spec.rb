...
RSpec.describe User, type: :model do
  describe "associations" do
    ...
    # Feed
    it { is_expected.to have_many(:subscribes) }
    it { is_expected.to have_many(:subscribers).through(:subscribes) }
  ...
  describe "#connected_with_since" do
    ...
    context "when the user is only subscribing the other user" do
      before do
        create :subscribe, user: other_user, subscriber: user, created_at: Date.yesterday
      end
